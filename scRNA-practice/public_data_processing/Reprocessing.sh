...
LSF_DOCKER_PRESERVE_ENVIRONMENT=false bsub -q martyomov -G compute-martyomov \
        -n 2 -o Reprocessing.out \
        -e Reprocessing.err -R 'rusage[mem=32GB] span[hosts=1]' \
	-J Reprocessing -M 32GB \
        -a "docker(kalisaz/scrna-extra:r4.3.0)" /bin/bash -c \
	"Rscript /scratch1/fs1/martyomov/carisa/Cross_Tissue_Cell_Atlas/CD8_processing.R"
